...
### 📈 Featured Projects
- **[Senior Capstone: Monetary Policy & Housing Affordability](https://github.com/your-username/monetary-policy-housing-affordability)** A time-series econometric model built in Stata using first-differenced OLS to isolate the policy transmission lags and momentum driving U.S. housing prices.(https://github.com/tdanglee33-glitch/monetary-policy-housing-affordability.git)
